...
// ============================================================================
// DSL case-sensitivity test
// ============================================================================

func TestWebMatch_DSLCaseSensitivity(t *testing.T) {
	// Build a minimal engine with a single DSL template that uses mixed-case literals.
	// Before the fix, WebMatch lowercased the body before passing it to DSL matchers,
	// causing contains(body, "<title>Nacos") to fail on a page with <title>Nacos</title>.
